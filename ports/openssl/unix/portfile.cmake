...
if(VCPKG_TARGET_IS_ANDROID)
    ...
    if(VCPKG_DETECTED_CMAKE_ANDROID_ARCH MATCHES "^(x86_64|x86)$")
        # NDK's bundled clang integrated assembler doesn't support the AVX512
        # SM3/SM4 mnemonics OpenSSL's x86_64 perlasm emits; we don't use those
        # ciphersuites, so drop them instead of losing asm for everything else.
        vcpkg_list(APPEND CONFIGURE_OPTIONS no-sm2 no-sm3 no-sm4)
    endif()
